...
int main() {
    ...
    std::chrono::duration<double> readFileTime = end-start;
    ...
    auto end = std::chrono::high_resolution_clock::now();
    std::chrono::duration<double> createResultFileTime = end - start;
    ...
    auto end = std::chrono::high_resolution_clock::now();
    std::chrono::duration<double> readResultFileTime = end - start;
