...
void writeResultsToFile(const std::vector<Studentas>& studentai, const std::string& vargsiukaiFileName, const std::string& galvociaiFileName) {
    ...
    vargsiukaiFile << std::setw(15) << std::left << "Vardas" << std::setw(15) << std::left << "Pavard " << std::setw(15) << std::right << "Galutinis" << std::endl;
    vargsiukaiFile << "---------------------------------------------------------------------" << std::endl;

    galvociaiFile << std::setw(15) << std::left << "Vardas" << std::setw(15) << std::left << "Pavard " << std::setw(15) << std::right << "Galutinis" << std::endl;
